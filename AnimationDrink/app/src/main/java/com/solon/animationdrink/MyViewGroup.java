        ...
        for (int i = 0 ; i < size ; i++){
            ...
            if (child instanceof  BigView){
                ...
                if (view.getLocation() == curr) {
                    ...
                    view.setPostionX((int) (width * currOffset));
                    view.setPostionY((int) (height * offset));

                }else if(view.getLocation() == curr - 1){

                    float offset = (currOffset < 1 ? 1 - currOffset + 1.2f : currOffset);
                    view.setPostionX((int) (width * (-1 + currOffset)));
                    view.setPostionY((int) (height * offset));

                }else if(view.getLocation() == curr + 1){

                    view.setPostionX((int) (width * (1 + currOffset)));
                    view.setPostionY((int) (height * (-1 + currOffset)));

                }
//                view.setPostionY((int) (height * 0.5f));
                ...
                view.setPostionX(view.getLocation() / 2 == 0 ? offsetX : getMeasuredWidth() - offsetX );

                int offsetY = (int) (getMeasuredHeight() *1.0f * offset);
                view.setPostionY(view.getLocation() / 2 == 0 ? offsetY : getMeasuredHeight() - offsetY);
            }
        }
    }
